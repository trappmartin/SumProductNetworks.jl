...
"""
    gradient!(spn::SumProductNetwork, llhvals::AxisArray [, gradvals::AxisArray])

Compute the gradient of Sum Product Networks with respect to internal nodes.
"""
...
"""
    diff!(n::Node, llhvals::AxisArray, gradvals::AxisArray)
